# Generated by Django 3.2.19 on 2023-06-22 10:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(db_index=True, max_length=255, unique=True, verbose_name='Username в Telegram')),
                ('firstname', models.CharField(blank=True, default='', max_length=60, verbose_name='Имя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reports', to='telegram_meetup.event', verbose_name='Мероприятие')),
